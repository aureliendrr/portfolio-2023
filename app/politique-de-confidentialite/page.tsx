...
export default function PrivacyPolicy() {
  return (
    <>
      <Titre className='pt-32' margin="small">Politique de confidentialité</Titre>
      <p>Le site web http://aurelien-durier.fr est détenu par Aurélien Durier, qui est un contrôleur de données de vos données personnelles.
        <br />
        Nous avons adopté cette politique de confidentialité, qui détermine la manière dont nous traitons les informations collectées par http://aurelien-durier.fr, qui fournit également les raisons pour lesquelles nous devons collecter certaines données personnelles vous concernant. Par conséquent, vous devez lire cette politique de confidentialité avant d'utiliser le site web de http://aurelien-durier.fr.
        <br />
        Nous prenons soin de vos données personnelles et nous nous engageons à en garantir la confidentialité et la sécurité.</p>
      <Titre className="mt-10" margin="small">Les informations personnelles que nous collectons</Titre>
      <p>Lorsque vous visitez le http://aurelien-durier.fr, nous recueillons automatiquement certaines informations sur votre appareil, notamment des informations sur votre navigateur web, votre adresse IP, votre fuseau horaire et certains des cookies installés sur votre appareil. En outre, lorsque vous naviguez sur le site, nous recueillons des informations sur les pages web ou les produits individuels que vous consultez, sur les sites web ou les termes de recherche qui vous ont renvoyé au site et sur la manière dont vous interagissez avec le site. Nous désignons ces informations collectées automatiquement par le terme "informations sur les appareils". En outre, nous pourrions collecter les données personnelles que vous nous fournissez (y compris, mais sans s'y limiter, le nom, le prénom, l'adresse, les informations de paiement, etc.) lors de l'inscription afin de pouvoir exécuter le contrat.</p>
      <Titre className="mt-10" margin="small">Pourquoi traitons-nous vos données ?</Titre>
      ...
      <Titre className="mt-10" margin="small">Liens vers d'autres sites web</Titre>
      ...
      <Titre className="mt-10" margin="small">Sécurité de l'information</Titre>
      ...
      <Titre className="mt-10" margin="small">Divulgation légale</Titre>
      ...
      <Titre className="mt-10" margin="small">Informations de contact</Titre>
      <p>Si vous souhaitez nous contacter pour comprendre davantage la présente politique ou si vous souhaitez nous contacter concernant toute question relative aux droits individuels et à vos informations personnelles, vous pouvez envoyer un courriel à adurier.pro@gmail.com.</p>
    </>
  );
}